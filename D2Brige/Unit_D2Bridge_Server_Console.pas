...
begin
 D2BridgeServerController:= TDashBoardWebAppGlobal.Create(nil);
 ...
 vServerPort:= D2BridgeServerController.Prism.INIConfig.ServerPort(80);
 vServerName:= D2BridgeServerController.Prism.INIConfig.ServerName('DashBoard');

 D2BridgeServerController.APPName:= 'DashBoard';

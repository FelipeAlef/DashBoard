...
uses
  FMX.Forms, FMX.Layouts, System.Classes, RESTRequest4D,
  System.JSON, FireDAC.Comp.Client, System.IOUtils, System.SysUtils,
  System.IniFiles, FMX.SearchBox,
  FireDAC.DApt,
  FireDAC.Stan.Async,
  DataSet.Serialize, FMX.ListView.Types, FMX.TextLayout, System.Types,
...
//    class function OpenQuery(const pCommand : string; pArgs : array of const) : TJSONArray;
//    class function OpenQuery2(const pCommand : string; pArgs : array of const) : TJSONObject;
...
//end;
//
//class function TUtils.OpenQuery(const pCommand : string; pArgs : array of const) : TJSONArray;
//var
//  FC : TFDConnection;
//  Qr : TFDQuery;
//begin
...
//      Result := Qr.ToJsonArray;
//    except
//      on E : Exception do
//        raise Exception.Create('Erro no metodo OpenQuery.' + sLineBreak + E.Message);
//    end;
//  finally
//    FC.connected := False;
//    FreeAndNil(Qr);
...
//end;
//
//class function TUtils.OpenQuery2(const pCommand : string; pArgs : array of const) : TJSONObject;
//var
//  FC : TFDConnection;
//  Qr : TFDQuery;
//begin
...
//      Qr := GetQuery(FC);
//      Qr.Open(Format(pCommand, pArgs));
//      Result := Qr.ToJSONObject;
//    except
//      on E : Exception do
//        raise Exception.Create('Erro no metodo OpenQuery2.' + sLineBreak + E.Message);
//    end;
//  finally
//    FC.connected := False;
//    FreeAndNil(Qr);
